...
const testimonials = [
  {
    ...
    content: 'KingSquare found us the perfect penthouse in Naigaon within two weeks. Their attention to our specific requirements was remarkable. The entire process was seamless.',
    rating: 5,
    property: 'Oceanfront Penthouse, Naigaon',
  },
  {
    name: 'Priya Kapoor',
    ...
    rating: 5,
    property: 'Vasai Sky Penthouse',
  },
  {
    name: 'Arjun Shah',
    role: 'Film Producer',
    photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=2670&auto=format&fit=crop',
    content: 'The team at KingSquare went above and beyond for our family estate in Vasai. Their understanding of luxury lifestyle needs is unmatched. Truly world-class service.',
    rating: 5,
    property: 'Beachfront Villa, Vasai',
  },
  {
    name: 'Sarah Mitchell',
    role: 'CEO, Mitchell Group',
    photo: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=1361&auto=format&fit=crop',
    content: 'Investing in Virar property through KingSquare was the best decision. Their international network and local expertise made a complex process feel effortless.',
    rating: 5,
    property: 'Virar West Residence',
  },
];
